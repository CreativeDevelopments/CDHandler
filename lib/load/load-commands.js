        ...
        switch (_b.label) {
            case 0:
                ...
                _loop_1 = function (file) {
                    var isFolder, cmd_1, _c, _d, command, category, categoryGetter, category, categoryGetter, urls_1, json_1;
                            ...
                            case 2:
                                ...
                                if (!cmd_1.name)
                                    ...
                                    if (!cmd_1.slash && !cmd_1.data) {
                                        ...
                                        if (cmd_1.aliases) {
                                            for (_c = 0, _d = cmd_1.aliases; _c < _d.length; _c++) {
                                                command = _d[_c];
                                        ...
                                        json_1 = {
                                            name: cmd_1.name,
                                            description: (_a = cmd_1.description) !== null && _a !== void 0 ? _a : "No description",
                                            "options": cmd_1.data
                                        };
                                ...
                                return [3 /*break*/, 4];
                            case 3: return [2 /*return*/, "continue"];
