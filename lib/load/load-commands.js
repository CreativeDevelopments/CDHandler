        ...
        switch (_e.label) {
            case 0:
                ...
                _loop_1 = function (file) {
                    var isFolder, cmd_1, _f, _g, command, category, categoryGetter, slashes, slashCommand, deleted_1, category, categoryGetter, urls_1, json_1;
                    return __generator(this, function (_h) {
                        switch (_h.label) {
                            ...
                            case 4:
                                ...
                                if (cmd_1.aliases) {
                                    for (_f = 0, _g = cmd_1.aliases; _f < _g.length; _f++) {
                                        command = _g[_f];
                            ...
                            case 6:
                                slashes = _h.sent();
                                slashCommand = (_b = slashes.find(function (s) { return s.name.toLowerCase() == cmd_1.name; })) !== null && _b !== void 0 ? _b : null;
                                if (!(slashCommand == null)) return [3 /*break*/, 7];
                                return [2 /*return*/, "continue"];
                            case 7: 
                            // @ts-ignore
                            return [4 /*yield*/, client.api.applications((_c = client.user) === null || _c === void 0 ? void 0 : _c.id).commands(slashCommand.id).delete().catch(function (err) { return console.error(err); })];
                            case 8:
                                // @ts-ignore
                                _h.sent();
                                console.log(cdcolours_1.default("[CDHandler]", { textColour: "red" }) + " Deleting slash command " + slashCommand.name);
                                _h.label = 9;
                            ...
                            case 10:
                                cmd_1.servers.forEach(function (server) { return __awaiter(void 0, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_d) {
                                        switch (_d.label) {
                                            case 0: return [4 /*yield*/, client.api.applications((_a = client.user) === null || _a === void 0 ? void 0 : _a.id).guilds(server.id).commands.get().catch(function (err) { return console.error(err); })];
                                            case 1:
                                                sls = _d.sent();
                                                sl = (_b = sls.find(function (s) { return s.name.toLowerCase() == cmd_1.name; })) !== null && _b !== void 0 ? _b : null;
                                                if (!(sl == null)) return [3 /*break*/, 2];
                                                return [2 /*return*/];
                                            case 2: 
                                            // @ts-ignore
                                            return [4 /*yield*/, client.api.applications((_c = client.user) === null || _c === void 0 ? void 0 : _c.id).guilds(server.id).commands(sl.id).delete().catch(function (err) { return console.error(err); })];
                                            case 3:
                                                // @ts-ignore
                                                _d.sent();
                                                deleted_1 = true;
                            ...
                            case 12:
                                ...
                                json_1 = {
                                    name: cmd_1.name,
                                    description: (_d = cmd_1.description) !== null && _d !== void 0 ? _d : "No description",
                                    "options": cmd_1.data
                                };
