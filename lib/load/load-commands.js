...
var register = function (dir, Fcommands, Faliases, Fcategories, Fcategory) { return __awaiter(void 0, void 0, void 0, function () {
    var exists, files, _i, files_1, file, isFolder, cmd, _a, _b, command, category, categoryGetter;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                register(path_1.join(dir, file), Fcommands, Faliases, Fcategories, Fcategory);
                return [3 /*break*/, 5];
            case 2:
                if (!(file.endsWith(".coffee") || file.endsWith(".js") || file.endsWith(".ts") && !file.endsWith(".d.ts"))) return [3 /*break*/, 4];
            ...
            case 3:
                ...
                if (!cmd.name)
                ...
                else if (!cmd.fire && !cmd.callback && !cmd.run && !cmd.execute)
                    throw new Error(cdcolours_1.default("[FIRE-HANDLER] [ERROR]", { textColour: "red" }) + " Command without fire function");
                else {
                    Fcommands.set(cmd.name.toLowerCase(), cmd);
                    console.log(cdcolours_1.default("[CDHandler]", { textColour: "blue" }) + " Loading command " + cmd.name);
                    if (cmd.aliases) {
                    ...
                    category = cmd.category || Fcategory || "Misc";
