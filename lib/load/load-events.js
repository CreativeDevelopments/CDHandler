    ...
    return __generator(this, function (_a) {
        loader_1.default(dir, function (_a) {
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                var loaded, event_1, event_2;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (filename.endsWith('.d.ts'))
                                return [2 /*return*/];
                            loaded = function () { return console.log(cdcolours_1.default("[CDHandler]", { textColour: "green" }) + (" Loading event " + name)); };
                            if (!filename.endsWith(".ts")) return [3 /*break*/, 2];
                            return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require(path)); })];
                        case 1:
                            event_1 = (_b.sent()).default;
                            client.on(name, event_1.bind(null, client));
                            return [2 /*return*/, loaded()];
                        case 2:
                            if (ext in require.extensions) {
                                event_2 = require(path);
                                client.on(name, event_2.bind(null, client));
                                return [2 /*return*/, loaded()];
                            }
                            return [2 /*return*/];
                    }
