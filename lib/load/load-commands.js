                    ...
                    return __generator(this, function (_h) {
                        switch (_h.label) {
                            ...
                            case 5:
                                ...
                                return [4 /*yield*/, client.api.applications((_a = client.user) === null || _a === void 0 ? void 0 : _a.id).commands.get()];
                            case 6:
                                slashes = _h.sent();
                            ...
                            case 7: 
                            // @ts-ignore
                            return [4 /*yield*/, client.api.applications((_c = client.user) === null || _c === void 0 ? void 0 : _c.id).commands(slashCommand.id).delete()];
                            case 8:
                                // @ts-ignore
                                _h.sent();
                            ...
                            case 10:
                                cmd_1.servers.forEach(function (server) { return __awaiter(void 0, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_d) {
                                        switch (_d.label) {
                                            case 0: return [4 /*yield*/, client.api.applications((_a = client.user) === null || _a === void 0 ? void 0 : _a.id).guilds(server.id).commands.get()];
                                            case 1:
                                                sls = _d.sent();
                                            ...
                                            case 2: 
                                            // @ts-ignore
                                            return [4 /*yield*/, client.api.applications((_c = client.user) === null || _c === void 0 ? void 0 : _c.id).guilds(server.id).commands(sl.id).delete()];
                                            case 3:
                                                // @ts-ignore
                                                _d.sent();
                                                deleted_1 = true;
